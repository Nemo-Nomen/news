...
| **Kategorier** | Fem kategorier, definitioner uppdaterade 2026-09-20: **Arbete** (handskriven, ej från surfhistorik) — jobbar med teknik och affärsutveckling; stora nyheter/rapporter om H&M och konkurrenter: vad de satsar på, hur det går (resultat), hur marknaden reagerar. **Investeringar och privatekonomi** — privata investeringar + relevant ekonomi. **Politik** = makroekonomi och policy, globalt/EU/Sverige/Stockholm — inte allmän partipolitik. **Nöje** = teknik, bilar, hantverk. **AI** (ny kategori) — hur företag applicerar/transformerar verksamhet med AI, stora kapabilitetsnyheter, praktiska tricks att lära sig själv, allmän utveckling. Se `config/interests.yaml` för detaljer (gitignorerad) |
