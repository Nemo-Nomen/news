...
**Källupptäckt via Omni (backlog-post tillagd 2026-09-22, ej påbörjad):** Omni själv är INTE en bra källa att prenumerera på (se resonemang nedan) - men deras artiklar listar ofta "Källor: [tidning A, tidning B...]" under varje sammanfattning. Idé: bläddra manuellt genom ett antal Omni-artiklar per kategori (politik, ekonomi, jobb, nöje, ai, skvaller) och notera vilka svenska primärkällor som återkommer oftast, som en genvägslista för att hitta fler bra RSS-flöden att lägga till i `config/trusted_international_feeds.yaml` - samma metod som redan gav Kortsikt och Fernando del Pino. Inget automatiserat pipeline-steg (Omni saknar RSS, kollat 2026-09-22: 404 överallt), utan en engångs- eller periodisk research-genomgång.
